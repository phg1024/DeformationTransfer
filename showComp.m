...
subplot(2, 3, 3), showMeshError(alignMesh(T1_tf, T1), T1, 'error'); colorbar;
figure;
showMeshError(alignMesh(T1_tf, T1), T1, 'error'); colorbar;
figure;
showMeshOverlay(T1, alignMesh(T1_tf, T1), 'overlay');